...
class PcapAnalyzer:
    ...
    def get_json(self):
        ...
        json_data = {
            ...
            "top_source_ips": self.get_top_ips()['source_ips'],
            "top_destination_ips": self.get_top_ips()['destination_ips'],
            "protocol_counts": self.get_protocol_stats(),
            "application_protocol_counts": self.get_application_protocols(),
            "top_ports": self.get_top_ports(),
            "tcp_flag_counts": self.get_tcp_flags()
        }
